...
- [x] 2.5 [T-130] Supprimer l’onglet Informations redondant de la fiche cagnotte, conserver uniquement les métriques objectif/reste dans le hero, puis afficher directement l’historique des contributions sous le hero sans barre de progression supplémentaire.

...
- [x] 3.6 [T-128] Reproduire la liste Membres selon le prototype avec recherche iconifiée, filtre de statut segmenté, avatar, identité regroupée, statut visuel et accès au détail, en conservant les filtres métier et la pagination.
...
- [x] 5.5 [T-128] Comparer visuellement la liste Membres avec le prototype, puis vérifier les états recherche, filtre, chargement, erreur, absence de résultat, pagination, clavier et responsive.

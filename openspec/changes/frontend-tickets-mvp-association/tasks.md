...
- [x] 4.6 [T-26] (P2) Filtre par catégorie de revenu dans la liste des membres.
...
- [x] 5.7 [T-39] (P0) Formulaire de modification d'un membre — variante Opérateur limitée aux champs téléphone, ville, pays, nom d'usage. — RG-MEM-017
...
- [x] 9.7 [T-63] (P2) Filtre par statut de cotisation (À payer / Partiellement payé / Payé / En retard). openapi:`listCampaignDues` (paramètre `status`)
...
- [x] 11.5 [T-75] (P1) Recalcul et rafraîchissement du reste à payer et du statut après chaque règlement enregistré. — RG-PAY-004 à RG-PAY-006
- [x] 11.6 [T-76] (P1) Masquage de l'action d'enregistrement sur une cotisation déjà soldée (statut Payé).
...
- [x] 14.2 [T-88] (P1) Autorisation de contributions multiples sans restriction de nombre ni de montant minimal pour un même membre. — RG-CAG-005
- [x] 14.3 [T-89] (P0) Masquage de l'action d'enregistrement pour un Opérateur dont `peut_enregistrer_paiements` = non.
- [x] 14.4 [T-90] (P1) Affichage de l'auteur et de l'horodatage de chaque contribution. — RG-CAG-007
...
- [x] 14.6 [T-92] (P2) Barre de progression objectif / reste à collecter, quand un objectif est défini.
...
- [x] 15.2 [T-94] (P1) Masquage de l'action d'enregistrement de contribution sur une cagnotte clôturée.

...
- [ ] 2.1 [T-3] (P0) Écran de connexion (identifiant + mot de passe), sans lien d'inscription. — US-ACC-001, RG-003 ; openapi:`login`
...
- [ ] 2.12 [T-14] (P0) Layout responsive commun (desktop / tablette / mobile) avec navigation adaptée à chaque taille d'écran.
- [ ] 2.13 [T-15] (P0) Composant dialogue de formulaire : superposé sur desktop/tablette, plein écran sur mobile.
...
- [ ] 8.1 [T-52] (P1) Écran liste des utilisateurs avec rôle applicatif affiché, réservé à l'Administrateur. — RG-ROLE-002 ; openapi:`listUsers`

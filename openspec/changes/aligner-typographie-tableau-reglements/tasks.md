...
- [ ] 1.6 [T-133] Relire le diff, vérifier `openspec validate`, `node scripts/tickets.mjs check` et les contrôles du ticket, puis préparer une PR ciblée vers `main` sans fusion ni push direct vers `main`.

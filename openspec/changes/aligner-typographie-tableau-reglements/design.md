...
Le contenu fonctionnel actuel est volontairement conservé : quatre colonnes, pagination, chargement, état vide, erreur et appel API de la feature. T-133 dépend de T-132 afin de partir de la version stabilisée du détail de campagne.

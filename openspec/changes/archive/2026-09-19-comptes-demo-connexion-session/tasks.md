...
- [x] 4.3 [T-107] Après revue, traiter les constats et vérifier les contrôles GitHub ; laisser la fusion au mainteneur ou à une demande explicite distincte, puis constater son résultat avant de cocher cette étape et d'archiver le change. PR #22 fusionnée sur `main`.

...
## Contribo project architecture

Read `../../AGENTS.md`, `../../CONTRIBUTING.md` and `../README.md` for the project
workflow and actual tools. Organize frontend responsibilities by feature in
`src/app/features/<feature>/`, with lazy routes and colocated tests. Keep global

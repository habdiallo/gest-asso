 ...
 * T-20) pour afficher le mode d'une contribution à une cagnotte (T-91), sans
 * dupliquer les libellés Espèces / Mobile Money / Virement bancaire.
 */
export function contributionMethodLabel(method: PaymentMethod): string {

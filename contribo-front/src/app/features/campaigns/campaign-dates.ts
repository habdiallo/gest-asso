/**
 * Formatage des dates de campagne en français, sans dépendre du `LOCALE_ID`
 * Angular (non configuré pour `fr-FR` dans ce socle). Reprend la logique de
 * `features/dashboard/dashboard-dates.ts` : les features ne s'important pas
 * entre elles, la fonction est donc dupliquée ici plutôt que partagée.
 */

 ...
 * `app-form-dialog` que le formulaire de modification. Le masquage mutuel avec
 * l'action "Désactiver" selon le statut courant (T-46) est également livré.
 * Les actions "Désactiver" et "Réactiver" sont masquées pour les rôles
 * Trésorier, Opérateur et Membre (T-47, RG-MEM-019) : `canDeactivate` et
 * `canReactivate` ne les autorisent que pour `UserRole.Administrator`.
